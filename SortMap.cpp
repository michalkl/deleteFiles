 ...
 * @param String path - œcie¿ka do folderu podanego przez u¿ytkownika
 */
void SortMap::deleteElementFromMap(std::multimap<long long int, FileInfo>::iterator iter){
	//zlicza wielkoœæ dir
...
//---------------------------------------------------------------------------/** * getDirSize - Funkcja zwraca wielkoœæ dirSize
 */long long int SortMap::getDirSize(){	return dirSize;}//---------------------------------------------------------------------------/** * clearDirSize - Funkcja zeruje i zwraca wielkoœæ dirSize
 */long long int SortMap::clearDirSize(){	dirSize = 0;	return dirSize;}